...
contract Quadratic {
    ...
    function getProject(address pAdd) public view returns(string memory, string memory, string memory) {
        return(p[pAdd].name, p[pAdd].pStartTime, p[pAdd].pEndTime);
    }
